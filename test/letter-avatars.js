...
describe('generateAvatarURL() gravatar enabled', function () {
  ...
  it('should return correct urls', function () {
    assert.strictEqual(avatars.generateAvatarURL('Daan Sprenkels', 'hello@dsprenkels.com', true), 'https://sdn.geekzu.org/avatar/d41b5f3508cc3f31865566a47dd0336b?s=400')
    assert.strictEqual(avatars.generateAvatarURL('Daan Sprenkels', 'hello@dsprenkels.com', false), 'https://sdn.geekzu.org/avatar/d41b5f3508cc3f31865566a47dd0336b?s=96')
  })
